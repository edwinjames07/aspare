            ...
            <div class="row">
                <div class="main-slider">
                    <div class="slide-text">
                        <h1>ASPARE</h1>
                        <p>Welcome to the ASPARE portal which helps you to easily calculate the criteria based outcome with ease, based on your Institution standards.Know more about NBA ?</p>
                        <a href="http://www.nbaind.org/" class="btn btn-common">ABOUT NBA</a>
                    </div>
