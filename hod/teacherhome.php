            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="enroled1.php">enrol staff</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="900ms">
                           <a href="downco.php"> <img src="images/new/icon3.png" alt="">  </a>
                        </div>
                        <h2>co analysis</h2>
                    </div>
                </div>
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="900ms">
                           <a href="subjectanalysis.php"> <img src="images/new/icon3.png" alt="">  </a>
                        </div>
                        <h2>overall subject analysis</h2>
                    </div>
                    </div>
                    ...
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                            <a href="modify.php"><img src="images/new/icon2.png" alt=""> </a>
                        </div>
