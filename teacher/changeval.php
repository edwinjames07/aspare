...
$sql11 = "UPDATE comment_test SET not_achieved='$not', slightly_achieved='$slight',moderatly_achieved='$mod',substantial='$sub' where bid= '$bid' AND subid='$subid' AND cid='$cid'";
