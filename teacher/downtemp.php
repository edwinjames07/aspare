        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title">TEACHERS HOME  </h1>
 ...
 <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                            <a href="addtest.php"><img src="images/new/icon2.png" alt=""> </a>
                        </div>
                        <h2>Template For Series</h2>
                    </div>
                </div>
...
<div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                            <a href=" addassign.php"><img src="images/new/icon2.png" alt=""> </a>
                        </div>
                        <h2>Template For Assignment</h2>
                    </div>
                </div>
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                            <a href=" adduni.php"><img src="images/new/icon2.png" alt=""> </a>
                        </div>
                        <h2>Template For University Mark</h2>
                    </div>
                </div>
