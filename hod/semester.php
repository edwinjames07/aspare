...
$sql = "SELECT * FROM semester order by sid ";
...
<body>
   ...
   <div style="width:35%;margin:0 auto;">
       <center> <h5>SEMESTER'S</h5></center>
    </br>
        <?php
      //echo $_SESSION['cid'];
      //echo $_SESSION['bid'];
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<table class=style="font-family:"Times New Roman", Times, serif;font-size:20px;>
                        <tr>
                            <th><a href="subject.php ? sd='.$sid.'" ><center><h6>'.$row["semester"].'</h6></center></th>
                        </tr>
                        
                      </table>';
            }
        } else {
    echo "<h6>NO SEMESTER....!</h6>";
        }
        ?> 
      </div>
    <!--/#home-slider-->
